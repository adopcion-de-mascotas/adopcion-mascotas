      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Somos un equipo multidisciplinario de 5 profesionales comprometidos con desarrollar soluciones
            tecnológicas innovadoras. Combinamos nuestras habilidades para crear herramientas que simplifiquen los procesos empresariales.
          </p>
        </div>

        <div id="team-container" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
