...
export default function MascotaFormEdit() {
  ...
  function handlePersonalidadChange(e) {
    ...
    setFormData((prev) => {
      ...
      if (checked) {
        if (!nuevaPersonalidad.includes(value)) nuevaPersonalidad.push(value);
      } else {
    ...
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400
                       focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent
                       transition duration-200"
            placeholder="Peso aproximado en kilogramos"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400
                       focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent
                       transition duration-200"
            placeholder="Estado donde se encuentra"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400
                       focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent
                       transition duration-200 resize-y"
            placeholder="Historia o antecedentes de la mascota"
            rows={4}
          />
        </div>
        ...
        <fieldset className="border border-gray-300 rounded-lg p-4">
          <legend className="text-gray-800 font-semibold mb-3 px-2">
            Personalidad
          </legend>
            ...
            {opcionesPersonalidad.map((item) => (
              ...
              >
                <input
                  type="checkbox"
                  value={item}
                  checked={formData.personalidad.includes(item)}
        ...
        <button
          ...
          className="w-full bg-green-600 text-white font-bold py-3 rounded-lg hover:bg-green-700
                     transition duration-300 shadow-md focus:outline-none focus:ring-4 focus:ring-green-400"
        >
          Guardar cambios
        </button>

        {mensaje && (
          <p className="text-green-700 text-center font-semibold mt-4">{mensaje}</p>
        )}
        {error && (
