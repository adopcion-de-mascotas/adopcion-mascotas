        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2">
              Comparte información valiosa con nuestra comunidad de amantes de
              mascotas
            </p>
          </div>
          ...
          {submitSuccess && (
            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-8">
              <div className="flex items-center">
                ...
                <span>
                  ¡Noticia enviada con éxito! Será publicada tras revisión.
                </span>
              </div>
            </div>
          )}
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  {formData.content.length}/150 caracteres mínimos
                </p>
              </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            <p>
              Todas las noticias son revisadas por nuestro equipo antes de ser
              publicadas.
            </p>
            <p className="mt-1">
              Gracias por contribuir a nuestra comunidad de Happy Paw!
            </p>
          </div>
        </div>
      </div>
